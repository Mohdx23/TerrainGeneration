...
public class TerrainGeneration : MonoBehaviour
{
    ...
    public void MakeVertexArray()
    {
        ...
        for (int i = 0, z = 0; z < totalVerticesZ; z++)
        {
            ...
            {
                Color color = heightMap.GetPixel((int)(x * ratioX), (int)(z * ratioZ));//Pixel determine on the image we have used as the heightMap. Multiplying by ratio so its relative value is adjusted accordingly.
